  ...
  const renderDeleteModal = () => {
    ...
    return (
      <DeleteConfirmModal
        ...
        title={`حذف السؤال: ${questionSnippet.length > 35 ? questionSnippet.slice(0, 35) + '...' : questionSnippet}`}
        warningMessage="هل أنت متأكد من رغبتك في حذف هذا السؤال من بنك الأسئلة؟ — لا يمكن التراجع عن هذا الإجراء وسيتم إزالته من جميع المجموعات المرتبطة."
